...
//CLEAR CACHE IF NEED TO
class Cache {
    
    static var imageCount = 0
    
    //clears cache if too igh
    static func incrementImageCacheCount(){
        
        imageCount = imageCount + 1
        
        if imageCount > MAXCACHEIMAGES {
            SDImageCache.shared.clearMemory()
            print("SDImageCache Cleared")
            imageCount = 0
        }
...
extension UIImageView
{
    func dissolveImage(image:UIImage)
    {
...
extension UIImageView {
    ...
    {        self.sd_setImage(with: url, placeholderImage: placeholder, options: .scaleDownLargeImages) { (image, error, cacheType, url) -> Void in
...
extension UIImage {
  ...
  public func resized(toWidth width: CGFloat) -> UIImage? {
    ...
    public func resizedSquare(toWidth width: CGFloat) -> UIImage? {
